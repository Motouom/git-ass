...
function SideBar() {
  ...
  return (
    <>
      {!isOpen && (
        <button
          className="block sm:hidden mb-2 top-4 left-4 z-50 p-2 rounded-md bg-gray-800 text-white"
        ...
        <div className="shadow-2xl shadow-gray-900 h-full px-3 py-4 overflow-y-auto bg-gray-800 dark:bg-gray-800">
          <div className="flex items-center justify-between ps-2.5 mb-5">
            <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">
              <img
                src="/logo.png"
                className="w-14 h-14 rounded-full shadow-lg cursor-pointer shadow-blue-500"
                alt="PackIt"
              />
            </span>
            <button
              className="block sm:hidden p-2 rounded-md bg-gray-800 text-white"
              onClick={toggleSidebar}
            >
              <svg
                viewBox="0 0 24 24"
